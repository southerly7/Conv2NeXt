...
def get_args_parser():
    ...
    parser.add_argument('--max_dp', type=float, default=0.1, metavar='PCT',
                        help='higher drop_path bound for line schedulers that hit (0.1)')
    ...
    parser.add_argument('--weight_decay', type=float, default=0.05,
                        help='weight decay (default: 0.05/0.00004)')
...
def main(args):
    ...
    if args.layer_decay < 1.0 or args.layer_decay > 1.0:
        ...
        assert args.model in ['convnext_small', 'convnext_base', 'convnext_large', 'convnext_xlarge', 'Donvnext'], \
    ...
    # print("Use Cosine drop_path scheduler")
    # dp_schedule_values = utils.cosine_scheduler_dp(
    #     args.drop_path, args.max_dp, args.epochs, num_training_steps_per_epoch,
    #     warmup_epochs=args.warmup_epochs_dp
    # )
    ...
    # wd_schedule_values = utils.cosine_scheduler_2(
    #     args.weight_decay, args.weight_decay_end, args.epochs, num_training_steps_per_epoch,
    #     warmup_epochs=150
    # )
